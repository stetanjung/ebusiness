...
<div class="container">
	...
	<main>
	  <div class="sidebar">
	    <h3>My Account</h3>
		<a href="userInfo.php">Personal Infomation</a>
		<a href="shoppingCart.php">Shopping Cart</a>
		<a href="PurchaseHis.php">Purchase History</a>
		<a href="PurchaseHis.php">Notice Board</a>
		...
		<tr>
		  ...
		  <td id="unameEdit"><div class="btn-inverse" onclick="EditUname()">Edit</div></td>
		</tr>
		<tr>
		  <td><h3>Full name:</h3></td>
		  <td><h3 id="fname">#Full name </h3></td>
		  <td id="fnameEdit"><div class="btn-inverse" onclick="EditFname()">Edit</div></td>
		</tr>
		<tr>
		  <td><h3>Gender:</h3></td>
		  <td><h3 id="gender">#Gender </h3></td>
		  <td id="genderEdit"><div class="btn-inverse" onclick="EditGender()">Edit</div></td>
		</tr>
		<tr>
		  <td><h3>Age:</h3></td>
